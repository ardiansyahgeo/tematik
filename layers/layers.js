...
var format_BatasDesaKelurahan_9 = new ol.format.GeoJSON();
var features_BatasDesaKelurahan_9 = format_BatasDesaKelurahan_9.readFeatures(json_BatasDesaKelurahan_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BatasDesaKelurahan_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BatasDesaKelurahan_9.addFeatures(features_BatasDesaKelurahan_9);
var lyr_BatasDesaKelurahan_9 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_BatasDesaKelurahan_9, 
                style: style_BatasDesaKelurahan_9,
                interactive: true,
                title: '<img src="styles/legend/BatasDesaKelurahan_9.png" /> Batas Desa/Kelurahan'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_ESRISatellite_2.setVisible(true);lyr_INDEKSBAHAYABANJIRINARISKBNPB_3.setVisible(false);lyr_INDEKSBAHAYATSUNAMIINARISKBNPB_4.setVisible(true);lyr_INDEKSBAHAYAGEMPABUMIINARISKBNPB_5.setVisible(false);lyr_INDEKSBAHAYALONSGORINARISKBNPB_6.setVisible(false);lyr_StrukturGeologi_7.setVisible(true);lyr_TitikGempa5magTahun902022_8.setVisible(true);lyr_BatasDesaKelurahan_9.setVisible(false);
var layersList = [lyr_GoogleHybrid_0,lyr_OpenStreetMap_1,lyr_ESRISatellite_2,lyr_INDEKSBAHAYABANJIRINARISKBNPB_3,lyr_INDEKSBAHAYATSUNAMIINARISKBNPB_4,lyr_INDEKSBAHAYAGEMPABUMIINARISKBNPB_5,lyr_INDEKSBAHAYALONSGORINARISKBNPB_6,lyr_StrukturGeologi_7,lyr_TitikGempa5magTahun902022_8,lyr_BatasDesaKelurahan_9];
...
lyr_BatasDesaKelurahan_9.set('fieldAliases', {'NAMOBJ': 'Nama Obyek', 'WADMKC': 'Kecamatan', 'WADMKD': 'Kelurahan/Desa', 'jumlah_kk': 'Jumlah KK', 'pria': 'Jumlah Pria', 'wanita': 'Jumlah Wanita', 'Balita': 'Jumlah Balita', 'lansia': 'Jumlah Lansia', });
...
lyr_BatasDesaKelurahan_9.set('fieldImages', {'NAMOBJ': 'TextEdit', 'WADMKC': 'TextEdit', 'WADMKD': 'TextEdit', 'jumlah_kk': 'TextEdit', 'pria': 'TextEdit', 'wanita': 'TextEdit', 'Balita': 'Range', 'lansia': 'Range', });
...
lyr_BatasDesaKelurahan_9.set('fieldLabels', {'NAMOBJ': 'inline label', 'WADMKC': 'inline label', 'WADMKD': 'inline label', 'jumlah_kk': 'inline label', 'pria': 'inline label', 'wanita': 'inline label', 'Balita': 'inline label', 'lansia': 'inline label', });
lyr_BatasDesaKelurahan_9.on('precompose', function(evt) {
